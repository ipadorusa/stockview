import { getStockEarnings } from "@/lib/queries/stock-queries"
...
export async function EarningsTabServer({ ticker, market }: Props) {
  if (market === "KR") {
    return (
  ...
  if (!earnings.length) {
    return (
      <div className="text-center py-8 text-muted-foreground text-sm">실적 데이터가 없습니다</div>
    )
  }
