...
export function DividendHistory({ ticker }: DividendHistoryProps) {
  ...
  // 최근 연도 배당 요약 (OpenDART 데이터가 있는 경우만)
  const latestWithDart = data.dividends.find((d) => d.dividendYield != null || d.payoutRatio != null)
  const hasOpenDartData = data.dividends.some((d) => d.dividendYield != null || d.payoutRatio != null)
